...
type WidgetActionTriggerEventType =
  | Omit<ActionTriggerEventType, "onPageOpen">
  | "onFocus"
  | "onBlur";
...
type SerializedAdditionalActionsType = {
  [key in
    ...
    | WidgetActionTriggerEventType as string]?: {
    type: string;
    [key: string]: unknown;
  };
};
...
type TwoStepSignatureCallback = (arg0: {
  ...
  ArrayBuffer | SignatureCallbackResponsePkcs7 | SignatureCallbackResponseRaw
>;
...
type SigningServiceData =
  | ServerSigningServiceData
  | StandaloneSigningServiceData;
/**
 * *Server only*
 *
...
type DocumentEditorUIHandler = {
  setOperations: (
    callback: (
      stagedDocumentOperations: List<
        DocumentOperation | List<DocumentOperation>
      >
...
type DocumentEditorFooterItem = Omit<
  BasicDocumentEditorFooterItem,
  "type" | "onPress"
> &
  (
    | {
...
type DocumentEditorToolbarItem = Omit<ToolItem, "type" | "onPress"> &
  (
...
type IDocumentPermissions =
  (typeof DocumentPermissionsEnum)[keyof typeof DocumentPermissionsEnum];
...
declare class Instance {
  ...
  transformContentClientToPageSpace: <T extends Rect | Point>(
    rectOrPoint: T,
    pageIndex: number
  ) => T;
  transformContentPageToClientSpace: <T extends Rect | Point>(
    rectOrPoint: T,
    pageIndex: number
  ) => T;
  transformClientToPageSpace: <T extends Rect | Point>(
    rectOrPoint: T,
    pageIndex: number
  ) => T;
  transformPageToClientSpace: <T extends Rect | Point>(
    rectOrPoint: T,
    pageIndex: number
  ) => T;
  ...
  setLayersVisibilityState: (
    visibilityState: OCGLayersVisibilityState
  ) => Promise<void>;
...
interface IViewState {
  ...
  sidebarOptions:
    | SidebarOptions<AnnotationsSidebarOptions>
    | SidebarOptions<LayersSidebarOptions>
    | IObject;
...
type DocumentOperation =
  ...
  | NonSerializableDocumentOperationsCommon
...
declare const textComparisonActionCreators: {
  setInstances: (payload: { instanceA: Instance; instanceB: Instance }) => {
    type: "SET_INSTANCES";
    payload: {
      instanceA: Instance;
      instanceB: Instance;
...
type TextComparisonToolbarItemType =
  | ToolItemType
  | (typeof allowedTextComparisonToolbarItem)[number];
...
type TextComparisonInnerToolbarItemType =
  | ToolItemType
  | (typeof allowedTextComparisonInnerToolbarItem)[number];
...
type StandaloneTextComparisonConfiguration =
...
type IDocumentOfficeFormat =
  (typeof OfficeDocumentFormat)[keyof typeof OfficeDocumentFormat];
 ...
 */
declare function convertToOffice(
  configuration: StandaloneConfiguration,
  format: IDocumentOfficeFormat
): Promise<ArrayBuffer>;
/**
...
interface TextComparisonEventsMap {
  ...
  "textComparison.comparisonSidebarVisibilityChange": (
    scrollLockFlag: boolean
  ) => void;
...
declare class TextComparisonInstance {
  ...
  setToolbarItems: (
    toolbarItemsCallback: TextComparisonToolbarItem[] | SetToolbarItemsFunction
  ) => void;
  setInnerToolbarItems: (
    toolbarItemsCallback:
      | TextComparisonInnerToolbarItem[]
      | SetToolbarItemsFunction
  ) => void;
...
declare function loadTextComparison(
  configuration: TextComparisonConfiguration
): Promise<TextComparisonInstance>;
...
declare const PSPDFKit: {
  ...
  Annotations: {
    ...
    fromSerializableObject: <
      K extends AnnotationJSONUnion | AnnotationsBackendJSONUnion
    >(
      annotation: K
  ...
  I18n: {
    ...
    readonly preloadLocalizationData: (
      locale: string,
      options?: {
...
export {
  ...
  type DocumentEditorToolbarItem,
  DrawingPoint,
  EllipseAnnotation,
  type EllipseAnnotationJSON,
  Font,
  FormField,
  FormFieldValue,
  FormOption,
  ...
  InkAnnotation,
  type InkAnnotationJSON,
  Inset,
  Instance,
  InstantClient,
  type _Interfaces as Interfaces,
  JavaScriptAction,
  LaunchAction,
  LineAnnotation,
  type LineAnnotationJSON,
  LinkAnnotation,
  List,
  ListBoxFormField,
  type MentionableUser,
  NamedAction,
  NoteAnnotation,
  type NoteAnnotationJSON,
  OutlineElement,
  PageInfo,
  Point,
  PolygonAnnotation,
  type PolygonAnnotationJSON,
  PolylineAnnotation,
  type PolylineAnnotationJSON,
  type ProcessingAuthPayload,
  RadioButtonFormField,
  Rect,
  RectangleAnnotation,
  type RectangleAnnotationJSON,
  RedactionAnnotation,
  type RedactionAnnotationJSON,
  ResetFormAction,
  SearchResult,
  SearchState,
  ...
  SquiggleAnnotation,
  StampAnnotation,
  type StampAnnotationJSON,
  type StandaloneConfiguration,
  StrikeOutAnnotation,
  SubmitFormAction,
  type TemplateDataToPopulateDocument,
  TextAnnotation,
  type TextAnnotationJSON,
  _default as TextComparisonConfiguration,
  TextComparisonInstance,
  TextFormField,
  TextLine,
  TextMarkupAnnotation,
  type TextMarkupAnnotationJSON,
  type TextMarkupAnnotationsUnion,
  ...
  UnderlineAnnotation,
  UnknownAnnotation,
  type UnknownAnnotationJSON,
  ViewState,
  WidgetAnnotation,
  type WidgetAnnotationJSON,
  PSPDFKit as default,
};
