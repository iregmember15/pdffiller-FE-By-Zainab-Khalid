            ...
            <div className="w-full p-4">
              <div className="w-full bg-white shadow-md">
                <div className="flex justify-center gap-3 lg:gap-20 items-center bg-[#9AA1B0] py-4  px-2">
                  <div className="flex flex-col items-center justify-center border-t-4 border-[#245C21]">
                    <img
                      src="/chequeIcon.png"
                      alt="Cheque icon"
                      className="w-6 h-6"
                    />
                    <span className="text-[#245C21] font-bold">Cheque</span>
                  </div>

                  <img src={arrowIcon} alt="arrow icon" className="w-8 h-6" />

                  <div className="flex flex-col items-center justify-center border-t-4 border-[#E20000]">
                    <img
                      src="/user-pen-solid-1.png"
                      alt="createAPI icon"
                      className="w-6 h-6"
                    />
