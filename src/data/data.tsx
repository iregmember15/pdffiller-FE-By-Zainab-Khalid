...
export const toolsData = [
  ...
  {
    title: "Sign PDF",
    content: "Sign yourself or request electronic signatures from others.",
    icon: "/signPdfIcon.png",
    path: "/sign-pdf",
  },
  {
    title: "Workflows",
  ...
  },
  {
    ...
    content: "Turn your PDF files into easy-to-edit PPT and PPTX slideshows.",
    icon: "/pdfToPowerPointIcon.png",
    path: "/pdf-to-powerpoint",
  },
  {
    title: "Word to PDF",
    content: "Make DOC and DOCX files easy to read by converting them to PDF.",
    icon: "/wordToPdfIcon.png",
    path: "/word-to-pdf",
  },
  {
  ...
  {
    title: "Excel to PDF",
    content: "Make Excel spreadsheets easy to read by converting them to PDF.",
    icon: "/excelToPdfIcon.png",
    path: "/excel-to-pdf",
  },
  {
    title: "PDF to JPG",
  ...
  {
    title: "Repair PDF",
    content: "Repair a damaged PDF and recover data from corrupt PDFs.",
    icon: "/repairPdfIcon.png",
    path: "/repair-pdf",
  },
  {
    title: "Page Numbers",
  ...
  {
    title: "Summarize PDF",
    content: "Quickly extract and summarize key information from PDFs.",
    icon: "/summarizePdfIcon.png",
    path: "/summarize-pdf",
  },
  {
    title: "Translate PDF",
  ...
  {
    title: "Extract Pages",
    content: "Extract pages from PDF documents.",
    icon: "/extractPagesIcon.png",
    path: "/extract-pages",
  },
  {
    title: "Merge PDF",
    content: "Combine PDFs in the order you want.",
    icon: "/mergePdfIcon.png",
    path: "/merge-pdf",
  },
  {
    title: "Split PDF",
    content: "Separate one page or a whole set for easy conversion.",
    icon: "/mergePdfIcon.png",
    path: "/split-pdf",
  },
  {
    title: "Compress PDF",
    content: "Reduce file size while optimizing quality.",
...
export const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Legal And Privacy", path: "/legal-and-privacy" },
