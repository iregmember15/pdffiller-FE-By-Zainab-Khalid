...
export interface ApiAuthUserPartialUpdateRequest {
  patchedCustomUser?: Omit<
    PatchedCustomUser,
    "id" | "avatar_url" | "get_display_name"
  >;
}
...
export class ApiApi extends runtime.BaseAPI {
   ...
   */
  async apiAuthLoginCreateRaw(
    requestParameters: ApiAuthLoginCreateRequest,
   ...
   * Custom login view that checks if 2FA is enabled for the user.
   */
  async apiAuthLoginCreate(
    requestParameters: ApiAuthLoginCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<LoginResponse> {
    const response = await this.apiAuthLoginCreateRaw(
      requestParameters,
      initOverrides
    );
  ...
  async apiAuthLogoutCreateRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      RestAuthDetailFromJSON(jsonValue)
    );
  }
   ...
   * Calls Django logout method and delete the Token object assigned to the current User object.  Accepts/Returns nothing.
   */
  async apiAuthLogoutRetrieveRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RestAuthDetail>> {
    const queryParameters: any = {};
   ...
   */
  async apiAuthPasswordChangeCreateRaw(
    requestParameters: ApiAuthPasswordChangeCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RestAuthDetail>> {
   ...
   * Calls Django Auth SetPasswordForm save method.  Accepts the following POST parameters: new_password1, new_password2 Returns the success/fail message.
   */
  async apiAuthPasswordChangeCreate(
    requestParameters: ApiAuthPasswordChangeCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<RestAuthDetail> {
    const response = await this.apiAuthPasswordChangeCreateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async apiAuthRegisterCreateRaw(
    requestParameters: ApiAuthRegisterCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   * Registers a new user.  Accepts the following POST parameters: username, email, password1, password2.
   */
  async apiAuthRegisterCreate(
    requestParameters: ApiAuthRegisterCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<JWT> {
    const response = await this.apiAuthRegisterCreateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async apiAuthTokenRefreshCreateRaw(
    requestParameters: ApiAuthTokenRefreshCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TokenRefreshFromJSON(jsonValue)
    );
  }
   ...
   * Takes a refresh type JSON web token and returns an access type JSON web token if the refresh token is valid.
   */
  async apiAuthTokenRefreshCreate(
    requestParameters: ApiAuthTokenRefreshCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<TokenRefresh> {
    const response = await this.apiAuthTokenRefreshCreateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async apiAuthTokenVerifyCreateRaw(
    requestParameters: ApiAuthTokenVerifyCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   * Takes a token and indicates if it is valid.  This view provides no information about a token\'s fitness for a particular use.
   */
  async apiAuthTokenVerifyCreate(
    requestParameters: ApiAuthTokenVerifyCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<TokenVerify> {
    const response = await this.apiAuthTokenVerifyCreateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async apiAuthUserPartialUpdateRaw(
    requestParameters: ApiAuthUserPartialUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<CustomUser>> {
    const queryParameters: any = {};
   ...
   * Reads and updates UserModel fields Accepts GET, PUT, PATCH methods.  Default accepted fields: username, first_name, last_name Default display fields: pk, username, email, first_name, last_name Read-only fields: pk, email  Returns UserModel fields.
   */
  async apiAuthUserPartialUpdate(
    requestParameters: ApiAuthUserPartialUpdateRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<CustomUser> {
    const response = await this.apiAuthUserPartialUpdateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * Reads and updates UserModel fields Accepts GET, PUT, PATCH methods.  Default accepted fields: username, first_name, last_name Default display fields: pk, username, email, first_name, last_name Read-only fields: pk, email  Returns UserModel fields.
   */
  async apiAuthUserUpdateRaw(
    requestParameters: ApiAuthUserUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<CustomUser>> {
    const queryParameters: any = {};
   ...
   * Reads and updates UserModel fields Accepts GET, PUT, PATCH methods.  Default accepted fields: username, first_name, last_name Default display fields: pk, username, email, first_name, last_name Read-only fields: pk, email  Returns UserModel fields.
   */
  async apiAuthUserUpdate(
    requestParameters: ApiAuthUserUpdateRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<CustomUser> {
    const response = await this.apiAuthUserUpdateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async apiAuthVerifyOtpCreateRaw(
    requestParameters: ApiAuthVerifyOtpCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<JWT>> {
  ...
  /**
   */
  async apiAuthVerifyOtpCreate(
    requestParameters: ApiAuthVerifyOtpCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<JWT> {
    const response = await this.apiAuthVerifyOtpCreateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
